...
LayoutItem {
    ...
    QtObject {
        ...
        property string frontendDir: mamController.frontendDir
    ...
    QtObject {
        ...
        property int range: mam.rangeLimit
        property string pattern: ""
        property string category: mam.currentCategory
        property string sort: mam.currentSort
        property string source: mam.currentSource
        property string status: mam.currentStatus
        property bool technical: mam.techItemsShown
    ...
    function reloadData() {
        mam.resetView();
        mamController.search(controllerData);
    }
    ...
    function statusEnabled(c) {
        if (c === "N") {
            return mam.statusFilterNotInstalledEnabled;
        }
        else if (c === "I") {
            return mam.statusFilterInstalledEnabled;
        }
        else if (c === "U") {
            return mam.statusFilterUpgradeEnabled;
        }
        else if (c === "G") {
            return mam.statusFilterInstallingEnabled;
        }
        else {
            return false;
        }
